...
const SITE_SEARCH_INDEX = [
    { name: "Soluble Cutting Oil", cat: "Industrial Lubricants", desc: "Bio-stable water soluble metal cutting fluid with anti-rust protection.", url: "products/soluble-cutting-oil.html" },
    { name: "Straight / Neat Cutting Oil", cat: "Industrial Lubricants", desc: "Heavy-duty non-staining neat cutting oil for broaching and deep drilling.", url: "products/straight-cut-oil.html" },
    { name: "Hone Flush Oil & SPL", cat: "Industrial Lubricants", desc: "Ultra-low viscosity honing oil with flushing action for precision finishing.", url: "products/hone-flush-oil.html" },
    { name: "Loom Oils (Textile Machinery)", cat: "Industrial Lubricants", desc: "High scourability textile loom oils for high-speed weaving looms.", url: "products/loom-oils.html" },
    { name: "Quenching Oils (Heat Treatment)", cat: "Industrial Lubricants", desc: "Accelerated quenching and heat treatment oil for uniform hardness.", url: "products/quenching-oil.html" },
    { name: "Pneumatic Tool & Rock Drill Oils", cat: "Industrial Lubricants", desc: "High film-strength extreme-pressure oils for jackhammers and drills.", url: "products/pneumatic-oils.html" },
    { name: "Slideway Oils (Way Lubricants)", cat: "Industrial Lubricants", desc: "Tacky anti-stick-slip slideway oil for machine tool guideways.", url: "products/way-oils.html" },
    { name: "Press Oils (Metal Stamping)", cat: "Industrial Lubricants", desc: "Heavy-duty drawing and sheet metal stamping compounds.", url: "products/press-oils.html" },
    { name: "Freeze Oils (Refrigeration)", cat: "Industrial Lubricants", desc: "Ultra-low pour point compressor oils for NH3 and CFC systems.", url: "products/freeze-oils.html" },
    { name: "EDM Oil (Spark Erosion Fluid)", cat: "Industrial Lubricants", desc: "High dielectric strength spark erosion fluid with zero odor.", url: "products/edm-oil.html" },
    { name: "Rust Preventive Oils (RPO Series)", cat: "Industrial Lubricants", desc: "Dewatering rust preventive fluid for indoor and ocean export storage.", url: "products/rust-preventive-oil.html" },
